...
//            Modes:        OFF,   DH,    OFF,   IH,    OFF,   DM,    OFF,   AH,    AL,    DL
const short ir_val[10] =    {0,    la_h,  0,     0,     0,     la_m,  0,     la_h,  la_l,  la_l};
const short illum_val[10] = {0,    il_h,  0,     il_h,  0,     il_m,  0,     0,     0,     il_l};
